...
<link href="assets/css/bootstrap.min.css" rel="stylesheet">
 ...
 <?php 
      ...
      $tampil_data=mysqli_query($connection,"SELECT * FROM produk WHERE ProdukID='$ProdukID'");
      while($row=mysqli_fetch_array($tampil_data)){
      ?>

<form class="form-signin" method="post" action="proses_ubah_produk.php">
  ...
  <input type="number" id="inputStok" value="<?php echo $row['Stok']; ?>" name="Stok" class="form-control" placeholder="Stok" required>
