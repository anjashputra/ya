...
<form class="form-signin" method="post" action="proses_ubah_pelanggan.php">
  ...
  <input type="text" id="inputNomorTelepon" value="<?php echo $row['NomorTelpon']; ?>" name="NomorTelpon" class="form-control" placeholder="NomorTelepon" required>
